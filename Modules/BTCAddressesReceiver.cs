        ...
        public void AddCells(GoogleSheetParameters googleSheetParameters, List<GoogleSheetRow> rows)
        {
            ...
            foreach (var row in rows)
            {
                ...
                foreach (var cell in row.Cells)
                {
                    ...
                    //cellFormat.BackgroundColor = new System.Drawing.Color { Blue = (float)cell.BackgroundColor.B / 255, Red = (float)cell.BackgroundColor.R / 255, Green = (float)cell.BackgroundColor.G / 255 };
